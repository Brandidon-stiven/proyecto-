...
<body>
    <nav>
        <div class="row">
            ...
            <div class="col-md-3 col-ms-12"><a href="{{route('modulos')}}">INICIO</a></div>
    ...
    <section class="centro">
        <div class="row tamano">
            <div class="col-md-4 lista">
                ...
                <div class="row">
                    <div>
                        <button class="boton"><p>Agricola</p></button>
                    </div>
                </div>
                <div class="row">
                    <br>
                ...
                <div class="row">
                    <div>
                        <button class="boton"><p>Inventario</p></button>
                    </div>
                </div>
                <div class="row">
                    <br>
                ...
                <div class="row">
                    <div>
                        <button class="boton"><p>Compra y venta</p></button>
                    </div>
                </div>
                <div class="row">
                    <br>
